...
EVAL_PATH="/data2/jkx/LLaVA/playground/data/eval/MMMU"
CKPT="llava-v1.5-7b-lora-v47-top20-per005-lora"

python -m llava.eval.model_vqa_science \
    --model-path $MODEL_PATH \
    --question-file $EVAL_PATH/filtered_questions.json \
...
python /data2/jkx/LLaVA/scripts/v1_5/eval/evaluate_ai2d.py --pred_file $EVAL_PATH/answers/${CKPT}.jsonl --gt_file /data2/jkx/LLaVA/playground/data/eval/MMMU/answers.jsonl
