...
parser.add_argument('--checkpoint', type=str, default="/data2/jkx/LLaVA/checkpoints/llava-v1.5-7b")
parser.add_argument('--image', type=str, default="/data2/jkx/LLaVA/IMG_1888.JPG")
parser.add_argument('--prompt', type=str, default="Describe this image.")
parser.add_argument('--output', type=str, default="/data2/jkx/LLaVA/output")
...
def eval_model():
    disable_torch_init()
    model_name = get_model_name_from_path(args.checkpoint)
    tokenizer, model, image_processor, context_len = load_pretrained_model(
        model_path=args.checkpoint, model_base=None, model_name=model_name,
        load_4bit=True
    )
